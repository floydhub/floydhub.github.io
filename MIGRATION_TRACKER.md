# FloydHub Blog Migration Tracker

**Total Posts**: 83  
**Status**: 🔄 In Progress  
**Updated**: 2025-09-24 15:43
...
- Update status: ⏳ → 🔄 → ✅
- Add notes for any special handling needed
- Completed posts should have Jekyll URLs working

## Post List

| Status | Title | Slug | Author | Date | Jekyll URL | Notes |
|--------|-------|------|--------|------|------------|-------|
| ⏳ | FloydHub has shut down | `floydhub-has-shut-down` | Naren Thiagarajan | 2021-08-22 |  |  |
| ⏳ | NLP Datasets: How good is your deep learning model? | `nlp-datasets-how-to-train-and-evaluate-your-deep-learning-model` | Cathal Horan | 2020-06-10 |  |  |
| ⏳ | The Future of AI is Open | `the-future-of-ai-is-open` | Alessio Gozzoli | 2020-06-02 |  |  |
| ⏳ | FloydHub Cloud Setup Challenge:  Jupyter + TensorFlow in 44 seconds [WR] | `cloud-setup-challenge-jupyter-tensorflow` | Alessio Gozzoli | 2020-05-12 |  |  |
| ⏳ | Talking ML and Cloud Transformation at AI-First Companies with @searchguy, aka Antonio Gulli | `talking-ml-and-cloud-transformation-at-ai-first-companies-with-searchguy-aka-antonio-gulli` | Alessio Gozzoli | 2020-04-03 |  |  |
| ⏳ | Best Machine Learning Books (Updated for 2020) | `best-machine-learning-books` | Alessio Gozzoli | 2020-03-05 |  |  |
| ⏳ | AWS Cost Optimization for ML Infrastructure - EC2 spend | `aws-cost-optimization-for-ml-infra-ec2` | Naren Thiagarajan | 2020-02-12 |  |  |
| ⏳ | Tokenizers: How machines read | `tokenization-nlp` | Cathal Horan | 2020-01-28 |  |  |
| ⏳ | Emil’s Story as a Self-Taught AI Researcher | `emils-story-as-a-self-taught-ai-researcher` | Alessio Gozzoli | 2020-01-20 |  |  |
| ⏳ | Distilling knowledge from Neural Networks to build smaller and faster models | `knowledge-distillation` | Alex Amadori | 2019-11-11 |  |  |
| ⏳ | Naïve Bayes for Machine Learning – From Zero to Hero | `naive-bayes-for-machine-learning` | Anand Venkataraman | 2019-11-08 |  |  |
| ⏳ | A Pirate's Guide to Accuracy, Precision, Recall, and Other Scores | `a-pirates-guide-to-accuracy-precision-recall-and-other-scores` | Philip Kiely | 2019-10-31 |  |  |
| ⏳ | Introduction to Adversarial Machine Learning | `introduction-to-adversarial-machine-learning` | Arunava Chakraborty | 2019-10-16 |  |  |
| ⏳ | Training Neural Nets: a Hacker’s Perspective | `training-neural-nets-a-hackers-perspective` | Sayak Paul | 2019-09-20 |  |  |
| ⏳ | Attention Mechanism | `attention-mechanism` | Gabriel Loye | 2019-09-16 |  |  |
| ⏳ | Multiprocessing vs. Threading in Python: What Every Data Scientist Needs to Know | `multiprocessing-vs-threading-in-python-what-every-data-scientist-needs-to-know` | Sumit Ghosh | 2019-09-07 |  |  |
| ⏳ | When Not to Choose the Best NLP Model | `when-the-best-nlp-model-is-not-the-best-choice` | Cathal Horan | 2019-08-06 |  |  |
| ⏳ | N-Shot Learning: Learning More with Less Data | `n-shot-learning` | Heet Sankesara | 2019-08-02 |  |  |
| ⏳ | Gated Recurrent Unit (GRU) With PyTorch | `gru-with-pytorch` | Gabriel Loye | 2019-07-22 |  |  |
